...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        obs_last_action : bool, optional
            ...
            as part of observations (default is True).
        state_type : str, optional
            The type of state representation to use (default is "FP").
            Options are "FP" (Feature Pruned) or "EP" (Enhanced Pruned).
            This determines which YAML configuration file to load.
        ...
        obs_timestep_number : bool, optional
            ...
            (default is False).
        obs_agent_id : bool, optional
            Whether observations include the agent ID (default is True).
        state_agent_id : bool, optional
            Whether the state includes the agent ID (default is True).
        ...
        Note: Many state-related parameters (state_pathing_grid, state_terrain_height,
        state_last_action, state_timestep_number, etc.) are loaded from the state
        configuration file specified by state_type, rather than being passed as
        parameters.
        """
        # Map arguments
        state_config = self.load_state_config(state_type)
        ...
        # Override state parameters with values from state config
    ...
    def load_state_config(self, state_type):
        ...
        with open(state_config_path, "r", encoding="utf-8") as file:
    ...
    def step(self, actions):
        ...
        try:
            ...
            if terminated:
                ...
                dones = [bool(self.death_tracker_ally[agent_id]) for agent_id in range(self.n_agents)]
            else:
        ...
        if terminated and self._episode_steps >= self.episode_limit:
            info["truncated"] = True
